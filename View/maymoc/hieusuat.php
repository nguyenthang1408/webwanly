...
<header>
    ...
    <nav class="col-lg-12 col-12 navbar" style="">
        ...
        <a href="../Controller/index.php?action=selectaecdata#book">Tiến Độ</a>
...
<section class="book" id="book" style="">
    ...
    <div class="row" style="" id="divtimkiem">
            ...
            <ul class="list-inline" style="">
                <li class="list-inline-item col-lg-12 col-12" id="" style=""><a href="" style="" class="aps">Hiệu Suất</a></li>
            </ul>
            </div>
                <div class="container">
                  <div class="row" style="">
                    <div class="col-12 col-xs-12" style="">
                      ...
                      <input type="text" name="myInput" class="form-control" id="myInput" onkeyup="tableSearch()" placeholder="Tìm Kiếm Mã Thẻ" size="20" style="">
                      <input type="text" name="myInput" class="form-control classinput" size="20" id="myInput1" onkeyup="tableSearch1()" placeholder="Tìm Kiếm Họ Tên" style="">
                    </div>
                    </div>
