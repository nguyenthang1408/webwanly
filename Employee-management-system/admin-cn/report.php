	      ...
	      <tr class="bg-secondary text-white">
	        ...
	        <form action="" method="post">
	          <table style="width:100%" class="table-hover text-center ">
	          	<div align="center"><h2>點名名單</h2></div>
	            <tr>
	            	
	              <div align="center">
	                <input type="text" name="search" class="form-control" placeholder="工號" />
	                <input class="mt-2 btn btn-outline-primary" type="submit" value="搜索" name="btnsubmit" /></div>
	                <br />
	                </div> 
							...
							echo '<tr>
							  ...
							  $query1 = "SELECT * FROM attendance WHERE member_id = $id ORDER BY date limit 5";
								...
								while($rec1 = mysqli_fetch_array($result1))
								{
									...
									if($attendance1 ==0){
										echo "<td><font color='#FF0000'>缺勤</font></td>";
									}
									else{
										echo "<td><font color='#00FF00'>在位人員</font></td>";
									}
