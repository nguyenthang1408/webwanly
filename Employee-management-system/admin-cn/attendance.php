			...
			<div class="content-header">
				<div class="container-fluid">
					...
					<div class="col-sm-6">
						...
						<li class="breadcrumb-item active">點名</li>
						</ol>
					</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<!-- main codes clock calendar -->
							...
							<div class="row">
								<div class="col-sm-4 col-6">
									<div class="description-block border-right">
										...
										<span class="description-text">人數</span>
									</div>
									<!-- /.description-block -->
								</div>
								<!-- /.col -->
								<div class="col-sm-4 col-6">
									<div class="description-block border-right">
										...
										<span class="description-text">在位人員</span>
									</div>
									<!-- /.description-block -->
								</div>
								<!-- /.col -->
								<div class="col-sm-4 col-6">
									<div class="description-block">
										...
										<span class="description-text">缺勤</span>
									</div>
								</div>
							</div>
						</div>
							...
							<tbody>
								...
								<tr>
									...
									<td><select name="hinhthuc<?php echo $rows["id"] ?>">
											<option value="Phép năm">年休</option>
											<option value="Việc riêng">事假</option>
											<option value="Phép bệnh">病假</option>
											<option value="Tự do">曠工</option>
										</select>
									</td>
								</tr>
									<?php } ?>
					...
					<div class="card-footer clearfix">
						<input class="btn btn-primary btn-lg" id="save" type="submit" value="留存點名" name="btnsubmit">
					</div>
					<!-- /.card-footer -->
					</div>
				<!-- /.card -->
...
<?php require_once "include/footer-cn.php"; ?>