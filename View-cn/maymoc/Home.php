...
{
    header('Location: ../Controller/index.php?action=login-cn');
}
...
<header>
    ...
    <nav class="col-lg-12 col-12 navbar" id="nav" style="">
        <a href="../Controller/index.php?action=test2-cn#home" class="logo" style="font-size: 30px;" id="logo"><span>F</span>oxconn</a>
        <a href="../Controller/index.php?action=test2-cn#book" style="margin-left: 30px"><span>T</span>rang Chủ</a>
        <a href="../Employee-management-system/admin/dashboard.php">Điểm Danh</a>
        <a href="../Controller/index.php?action=home-cn#packages">Biểu Đồ</a>
        <a href="../Controller/index.php?action=home-cn#book">Tiến Độ</a>
        ...
        <div class="row">
          <div class="col-lg-4 col-4" id="divaec" onmouseover="divaec1()" onmouseout="divaec2()" onclick="divaec3()">
            ...
            <div class="small-box bg-info">
              ...
              <a href="../Controller/index.php?action=selectaecdata-cn#divtimkiem" class="small-box-footer" style="font-size:250%;">Thông Tin<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-4" id="divtsc" onmouseover="divtsc1()" onmouseout="divtsc2()" onclick="divtsc3()">
            ...
            <div class="small-box bg-success">
              ...
              <a href="../Controller/index.php?action=selecttscdata-cn#divtimkiem" class="small-box-footer" style="font-size:250%;">Thông Tin<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
            ...
            <div class="small-box bg-warning">
              ...
              <div class="icon">
                <i class="fas fa-briefcase"></i>
                  ...
                  <a href="../Controller/index.php?action=selectapsdata-cn#divtimkiem" class="small-box-footer" style="font-size:250%;">Thông Tin<i class="fas fa-arrow-circle-right"></i></a>
