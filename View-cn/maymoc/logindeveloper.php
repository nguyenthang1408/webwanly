...
header('Location: ../Controller/index.php?action=mypage-cn');
}
}
}
?>
...
<body class="body" style="background: #C2E2F2">
  ...
  <main>
    ...
    <img class="responsive-img" style="width: 250px;" src="../image/logo.jpg" />
      ...
      <h5 class="indigo-text">Trang Developer</h5>
      <div class="section"></div>
      ...
      <div class="container">
       ...
       <a href="../Controller/index.php?action=begin-cn">Chuyển Trang Đăng Nhập</a>
    </center>
    <div class="section"></div>
    <div class="section"></div>
  </form>
